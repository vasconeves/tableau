...
pics/image: "/posts/1755-lisbon-earthquake.jpg"
...
We then click on the `Shader` icon which is located where the mouse pointer is in the pics/image below.
